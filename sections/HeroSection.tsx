    ...
    <div className="relative flex xl:min-h-screen flex-col justify-center items-center px-4 mx-auto max-w-7xl mt-10">
      <div className="px-4 py-5 md:py-10 space-y-5">
        ...
        <motion.div
          ...
          <Link href="#LetWork" className="w-60 transform rounded-lg bg-slate-700 px-6 py-2 text-center font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
            Start Your Project
          </Link>
          <Link href="#ourprojects" className="w-60 transform text-center rounded-lg border border-gray-300 bg-white px-6 py-2 font-medium text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-100 dark:border-gray-700 dark:bg-black dark:text-white dark:hover:bg-gray-900">
            See Our Work
          </Link>
        </motion.div>
        <motion.div
